...
function App() {
  ...
  return (
    <WeekProvider> {/* ✅ Wrap everything inside WeekProvider */}
      <Router>
        <div className="app">
          {/* TOP SCOREBOARD BAR */}
          <Scoreboard />
          ...
          <header className="top-bar">
            <div className="top-bar-container">
              ...
              <div className="top-bar-actions">
                <a href="/get-started" className="top-bar-button get-started">Get Started</a>
                <a href="/upgrade" className="top-bar-button upgrade">Upgrade</a>
                <a href="/signin" className="top-bar-button login">Login</a>
              </div>
            </div>
          </header>
