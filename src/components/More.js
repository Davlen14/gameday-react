      ...
      <div className="dashboard-grid">
        <div className="dashboard-card trending">
          ...
          <div className="trending-list">
            <div className="trending-item">
              ...
              <div className="trend-team">Alabama</div>
              <div className="trend-change up">↑ 2</div>
            </div>
            <div className="trending-item">
              <div className="trend-rank">2</div>
              <div className="trend-team">Georgia</div>
              <div className="trend-change">-</div>
            </div>
            <div className="trending-item">
              <div className="trend-rank">3</div>
              <div className="trend-team">Ohio State</div>
              <div className="trend-change up">↑ 1</div>
            </div>
            <div className="trending-item">
              <div className="trend-rank">4</div>
              <div className="trend-team">Michigan</div>
              <div className="trend-change down">↓ 2</div>
            </div>
            <div className="trending-item">
              <div className="trend-rank">5</div>
              <div className="trend-team">Texas</div>
              <div className="trend-change up">↑ 3</div>
            </div>
          </div>
        </div>
          ...
          <div className="highlights-list">
            <div className="highlight-item">
              ...
              <div className="highlight-info">
                <div className="highlight-title">Spectacular 75-yard touchdown run</div>
                <div className="highlight-teams">Ohio State vs Michigan</div>
              </div>
            </div>
            <div className="highlight-item">
              <div className="highlight-image" style={{ backgroundColor: "#f0f0f0" }}>
              ...
              <div className="highlight-info">
                <div className="highlight-title">Last-second field goal win</div>
                <div className="highlight-teams">Alabama vs Auburn</div>
              </div>
            </div>
            <div className="highlight-item">
              <div className="highlight-image" style={{ backgroundColor: "#f0f0f0" }}>
              ...
              <div className="highlight-info">
                <div className="highlight-title">Incredible one-handed catch</div>
                <div className="highlight-teams">Georgia vs Florida</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="dashboard-card stat-leaders">
          ...
          <div className="stats-tabs">
            <button className="stat-tab active">Passing</button>
            <button className="stat-tab">Rushing</button>
            <button className="stat-tab">Receiving</button>
          </div>
          <div className="stat-leaders-list">
            <div className="stat-leader-item">
              <div className="leader-rank">1</div>
              <div className="leader-info">
                <div className="leader-name">C.J. Stroud</div>
                <div className="leader-team">Ohio State</div>
              </div>
              <div className="leader-stat">3,340 yds</div>
            </div>
            <div className="stat-leader-item">
              <div className="leader-rank">2</div>
              <div className="leader-info">
                <div className="leader-name">Bryce Young</div>
                <div className="leader-team">Alabama</div>
              </div>
              <div className="leader-stat">3,188 yds</div>
            </div>
            <div className="stat-leader-item">
              <div className="leader-rank">3</div>
              <div className="leader-info">
                <div className="leader-name">Caleb Williams</div>
                <div className="leader-team">USC</div>
              </div>
              <div className="leader-stat">3,015 yds</div>
            </div>
            <div className="stat-leader-item">
              <div className="leader-rank">4</div>
              <div className="leader-info">
                <div className="leader-name">Drake Maye</div>
                <div className="leader-team">North Carolina</div>
              </div>
              <div className="leader-stat">2,964 yds</div>
            </div>
            <div className="stat-leader-item">
              <div className="leader-rank">5</div>
              <div className="leader-info">
                <div className="leader-name">Stetson Bennett</div>
                <div className="leader-team">Georgia</div>
              </div>
              <div className="leader-stat">2,895 yds</div>
            </div>
          </div>
        </div>
          ...
          <div className="games-list">
            <div className="game-item">
              <div className="game-teams">
                <span className="game-team">Alabama</span>
                <span className="game-vs">vs</span>
                <span className="game-team">LSU</span>
              </div>
              <div className="game-info">
                <div className="game-time">Sat, 7:30 PM ET</div>
                <div className="game-channel">ESPN</div>
              </div>
            </div>
            <div className="game-item">
              <div className="game-teams">
                <span className="game-team">Ohio State</span>
                <span className="game-vs">vs</span>
                <span className="game-team">Michigan</span>
              </div>
              <div className="game-info">
                <div className="game-time">Sat, 12:00 PM ET</div>
                <div className="game-channel">FOX</div>
              </div>
            </div>
            <div className="game-item">
              <div className="game-teams">
                <span className="game-team">Georgia</span>
                <span className="game-vs">vs</span>
                <span className="game-team">Tennessee</span>
              </div>
              <div className="game-info">
                <div className="game-time">Sat, 3:30 PM ET</div>
                <div className="game-channel">CBS</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="analytics-grid">
        <div className="analytics-card">
          ...
          <div className="analytics-footer">
            <button className="analytics-button">Explore Model</button>
          </div>
        </div>
        ...
        <div className="analytics-card">
              ...
              <div className="efficiency-bars">
                <div className="efficiency-team">
                  ...
                  <div className="efficiency-bar">
                    <div className="efficiency-fill" style={{ width: "95%" }}></div>
                  </div>
                  <span>95.2</span>
                </div>
                <div className="efficiency-team">
                  <span>Alabama</span>
                  <div className="efficiency-bar">
                    <div className="efficiency-fill" style={{ width: "92%" }}></div>
                  </div>
                  <span>92.4</span>
                </div>
                <div className="efficiency-team">
                  <span>Tennessee</span>
                  <div className="efficiency-bar">
                    <div className="efficiency-fill" style={{ width: "89%" }}></div>
                  </div>
                  <span>89.7</span>
                </div>
              </div>
            ...
            <div className="efficiency-category">
              ...
              <div className="efficiency-bars">
                <div className="efficiency-team">
                  <span>Georgia</span>
                  <div className="efficiency-bar">
                    <div className="efficiency-fill defense" style={{ width: "97%" }}></div>
                  </div>
                  <span>97.1</span>
                </div>
                <div className="efficiency-team">
                  <span>Michigan</span>
                  <div className="efficiency-bar">
                    <div className="efficiency-fill defense" style={{ width: "93%" }}></div>
                  </div>
                  <span>93.8</span>
                </div>
                <div className="efficiency-team">
                  <span>Iowa</span>
                  <div className="efficiency-bar">
                    <div className="efficiency-fill defense" style={{ width: "90%" }}></div>
                  </div>
                  <span>90.6</span>
                </div>
              </div>
          ...
          <div className="analytics-footer">
            <button className="analytics-button">View All Teams</button>
          </div>
        </div>
          ...
          <div className="predictive-preview">
            <div className="ranking-list">
              <div className="ranking-item">
                ...
                <div className="ranking-team">Georgia</div>
                <div className="ranking-score">98.7</div>
              </div>
              <div className="ranking-item">
                <div className="ranking-number">2</div>
                <div className="ranking-team">Ohio State</div>
                <div className="ranking-score">96.4</div>
              </div>
              <div className="ranking-item">
                <div className="ranking-number">3</div>
                <div className="ranking-team">Alabama</div>
                <div className="ranking-score">95.2</div>
              </div>
              <div className="ranking-item">
                <div className="ranking-number">4</div>
                <div className="ranking-team">Michigan</div>
                <div className="ranking-score">93.8</div>
              </div>
              <div className="ranking-item">
                <div className="ranking-number">5</div>
                <div className="ranking-team">Tennessee</div>
                <div className="ranking-score">91.5</div>
              </div>
            </div>
          </div>
          <div className="analytics-footer">
            <button className="analytics-button">Full Rankings</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="tools-section">
      ...
      <div className="tools-grid">
        <div className="tool-card">
          ...
          <button className="tool-button">Compare Teams</button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button">Calculate Scenarios</button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button">Analyze Schedules</button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button">Explore Stats</button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button">Analyze Matchups</button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button">View Projections</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="history-featured">
        <div className="history-featured-image">
          <div className="history-featured-overlay">
            ...
            <button className="history-button">Watch the Play</button>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="more-container">
      ...
      <div className="more-tabs">
        ...
        >
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path fill="currentColor" d="M21.71,20.29L20.29,21.71C20.11,21.89 19.85,22 19.59,22C19.33,22 19.07,21.89 18.88,21.71L12,14.83L5.12,21.71C4.94,21.89 4.67,22 4.41,22C4.15,22 3.89,21.89 3.71,21.71L2.29,20.29C2.11,20.11 2,19.85 2,19.59C2,19.33 2.11,19.07 2.29,18.88L9.17,12L2.29,5.12C2.11,4.94 2,4.67 2,4.41C2,4.15 2.11,3.89 2.29,3.71L3.71,2.29C3.89,2.11 4.15,2 4.41,2C4.67,2 4.94,2.11 5.12,2.29L12,9.17L18.88,2.29C19.07,2.11 19.33,2 19.59,2C19.85,2 20.11,2.11 20.29,2.29L21.71,3.71C21.89,3.89 22,4.15 22,4.41C22,4.67 21.89,4.94 21.71,5.12L14.83,12L21.71,18.88C21.89,19.07 22,19.33 22,19.59C22,19.85 21.89,20.11 21.71,20.29Z" />
          </svg>
          Tools
        </button>
        <button 
      ...
      <style jsx>{`
        ...
        .trending-list, .highlights-list, .stat-leaders-list, .games-list {
          display: flex;
          flex-direction: column;
          gap: 12px;
        }
        ...
        .play-icon {
          ...
          width: 30px;
          height: 30px;
          background-color: rgba(212, 0, 28, 0.8);
          border-radius: 50%;
          display: flex;
          align-items: center;
          justify-content: center;
        ...
        .efficiency-team span:first-child {
          width: 80px;
        }

        .efficiency-team span:last-child {
          width: 40px;
          text-align: right;
          font-weight: 600;
        }
