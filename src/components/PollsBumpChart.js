...
const PollsBumpChart = ({ width, height, pollType, weekRange }) => {
  ...
  useEffect(() => {
    ...
    // Increase right margin to leave more space for the logo and text.
    ...
    svg.append("image")
      ...
      // Place the logo in the top-right area, factoring in the increased right margin.
    ...
    chartData.forEach((teamData) => {
      ...
      // Replace null ranks with 25 for the line’s continuity.
      ...
      path
        .on("mousemove", function (event) {
          ...
          // Adjust if tooltip goes beyond the chart wrapper boundary.
          ...
          tooltip
            .style("left", left + "px")
            .style("top", top + "px")
            // Faster fade-in for better responsiveness.
            .transition()
            .duration(100)
            .style("opacity", 1);
        })
    ...
    // (No global invisible rectangle for tooltip logic needed.)
