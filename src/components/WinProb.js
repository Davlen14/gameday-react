   // Enhanced Win Probability Component with key play analysis and improved visualization
   ...
   import {
     ...
     Legend,
     Filler,
     AnnotationPlugin // Import annotation plugin for marking key plays
   } from "chart.js";
   ...
   const WinProb = ({ gameId }) => {
     ...
     const options = useMemo(() => {
       ...
       // Create annotations for vertical lines and tooltips
       const annotations = {
         quarterLines: quarterMarkers.map((marker, index) => ({
           type: 'line',
           scaleID: 'x',
           value: marker.value,
