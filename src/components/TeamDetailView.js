...
// Calculate percentage lengths for each color segment (for internal 0..100 scale)
...
// Data for the color segments (internal gauge space 0..100)
const gaugeData = [
...
// Ticks at our domain breakpoints
...
const Gauge = ({ label, rawValue }) => {
  ...
  // Compute tick marks (mapping domain values to gauge space)
...
const TeamDetail = () => {
  ...
  // Helper: get team logo by school name
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch ratings (assumed to return an array with team and national averages)
  ...
  // Compute performance notes based on national averages.
  ...
  // Note box with national averages details
  const nationalNote = (
    <div className="performance-note">
      ...
      <p>
        ...
        Offense:{" "}
        {nationalAverages.offense && nationalAverages.offense.rating
          ? nationalAverages.offense.rating.toFixed(1)
          : "N/A"}
        <br />
        Defense:{" "}
        {nationalAverages.defense && nationalAverages.defense.rating
          ? nationalAverages.defense.rating.toFixed(1)
          : "N/A"}
      </p>
    </div>
  );
  ...
  return (
    <div className="team-dashboard">
      ...
      <main className="team-main-content">
        ...
        <div className="performance-notes" style={{ position: "absolute", top: "20px", right: "20px", background: "#fff", padding: "10px", border: "1px solid #ddd", borderRadius: "8px", boxShadow: "0 2px 5px rgba(0,0,0,0.1)" }}>
